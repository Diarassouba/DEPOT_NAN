let citations = [
    ...
    ["Quand un poisson sort de l'eau et qu'il dit que le caïman a mal à la tête, il faut croire", "Charle Ble Goude"]
  ]; 

  let compteur = document.querySelector('#text')
  let auteur = document.querySelector('#auteur')
  let boutton = document.querySelector('#nouvelle')
  let dernier = 0
  let nombreAleatoire 
  ...
  boutton.addEventListener('click', () =>
  {
    function genererNombreEntier(max) {
      ...
      nombreAleatoire = genererNombreEntier(22)
      compteur.innerHTML = citations[nombreAleatoire][0]
